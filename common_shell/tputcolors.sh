...
export ANSI_COLOR_LIGHT_RED="$ANSI_BOLD $ANSI_COLOR_RED $ANSI_COLOR_DEFAULT"
export ANSI_COLOR_LIGHT_GREEN="$ANSI_BOLD $ANSI_COLOR_GREEN $ANSI_COLOR_DEFAULT"
export ANSI_COLOR_LIGHT_YELLOW="$ANSI_BOLD $ANSI_COLOR_YELLOW $ANSI_COLOR_DEFAULT"
export ANSI_COLOR_LIGHT_BLUE="$ANSI_BOLD $ANSI_COLOR_BLUE $ANSI_COLOR_DEFAULT"
export ANSI_COLOR_LIGHT_MAGENTA="$ANSI_BOLD $ANSI_COLOR_MAGENTA $ANSI_COLOR_DEFAULT"
export ANSI_COLOR_LIGHT_CYAN="$ANSI_BOLD $ANSI_COLOR_CYAN $ANSI_COLOR_DEFAULT"
